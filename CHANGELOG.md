...
- [#5](https://github.com/ThisIsMissEm/adonisjs-atproto-oauth/pull/5) [`1826314`](https://github.com/ThisIsMissEm/adonisjs-atproto-oauth/commit/1826314a5ba60ede7c4bcb3bf746b3810f8bf9ba) Thanks [@ThisIsMissEm](https://github.com/ThisIsMissEm)! - Add extensibility for the `user` instance returned from `oauth.handleCallback`
...
- [#11](https://github.com/ThisIsMissEm/adonisjs-atproto-oauth/pull/11) [`492849f`](https://github.com/ThisIsMissEm/adonisjs-atproto-oauth/commit/492849f625e2728dad647011b3576b45b710bf80) Thanks [@ThisIsMissEm](https://github.com/ThisIsMissEm)! - Add vine.js rules for validating various AT Protocol string formats
...
- [#10](https://github.com/ThisIsMissEm/adonisjs-atproto-oauth/pull/10) [`fb74d09`](https://github.com/ThisIsMissEm/adonisjs-atproto-oauth/commit/fb74d092910e2f71974036a5d72e7c2388655fea) Thanks [@ThisIsMissEm](https://github.com/ThisIsMissEm)! - Add trace logging to OAuth Client CIMD requests

- [#8](https://github.com/ThisIsMissEm/adonisjs-atproto-oauth/pull/8) [`0a75007`](https://github.com/ThisIsMissEm/adonisjs-atproto-oauth/commit/0a75007dc811fffe71552383d89fc15745a2bc21) Thanks [@ThisIsMissEm](https://github.com/ThisIsMissEm)! - Fix registration to not send prompt=select_account as fallback
...
- [#9](https://github.com/ThisIsMissEm/adonisjs-atproto-oauth/pull/9) [`ac01826`](https://github.com/ThisIsMissEm/adonisjs-atproto-oauth/commit/ac018264cf634eb17506acebc7458bbbb2444e67) Thanks [@ThisIsMissEm](https://github.com/ThisIsMissEm)! - Omit, but warn, if jwks or jwks_uri are present in client metadata in development
